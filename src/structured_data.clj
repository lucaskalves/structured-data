...
(defn books->string [books]
  (let [booksAmount (count books)
        booksText   (cond
          (== booksAmount 0) "No books"
          (== booksAmount 1) "1 book. "
          :else  (str booksAmount " books. "))]
    (str booksText (apply str (interpose ". " (map book->string books))) ".")))
